...
public class MainFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        //mainPanel.setBackground(Color.RED); // Hintergrundfarbe auf Rot setzen
    ...
    private void showLexikon() {
        ...
        String schritteText = "Vorbereitung\n\n" +
        ...
        String regelnText = "Regeln des Schachs:\n" +
        ...
        String figurenText = "Schachfiguren:\n\n" +
        ...
        String tippsText = "Tipps und Tricks:\n\n" +
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
                    // Setze das Look and Feel des Swing-Fensters
